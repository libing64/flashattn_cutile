"""cuTile FlashAttention-v1: classic online softmax with per-tile rescale."""
...
def _flash_v1_kernel(
    ...
    for j in range(0, Tc):
        ...
        # FA-v1: apply mask every iteration when needed (no loop split).
...
def flash_attention_v1(
    ...
    *,
    ...
    """Launch FA-v1 cuTile kernel. Tensors: [B, H, S, D]. Fixed small tiles by default."""
